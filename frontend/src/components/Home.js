    ...
    <div className="bg bg-info">
      ...
      <div className="container">
        <div className="row ">
          ...
          <div className="col-md-3 mt-3">
            <div className="card">
            <div className="thumbnail" style={{backgroundImage: "url('models/headphones.png')"}}>
          ...
          <div className=" col-md-3 mt-3">
            <div className="card">
            <div className="thumbnail" style={{backgroundImage: "url('models/globe.png')"}}>
          ...
          <div className="col-md-3 mt-3">
            <div className="card">
            <div className="thumbnail" style={{backgroundImage: "url('models/watch.png')"}}>
